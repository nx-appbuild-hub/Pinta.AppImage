...
all: clean
	...
	wget --output-document=./mono/build.rpm http://mirror.centos.org/centos/8/AppStream/x86_64/os/Packages/gtk3-3.22.30-5.el8.x86_64.rpm
	cd ./mono && rpm2cpio build.rpm | cpio -idmv && cd ..
	...
	wget --output-document=./mono/build.rpm http://mirror.centos.org/centos/8/AppStream/x86_64/os/Packages/librsvg2-2.42.7-3.el8.x86_64.rpm
	cd ./mono && rpm2cpio build.rpm | cpio -idmv && cd ..
